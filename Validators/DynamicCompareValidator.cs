...
namespace Website.Validation {
    /// <summary>
    /// A CompareValidator control that can be enabled/disabled by the same methods and properties as are provided in
    /// the <seealso cref="Website.Validation.BaseDynamicValidator"/> class
    /// </summary>
    /// <remarks>Note that this class inherits the class <see cref="System.Web.UI.WebControls.CompareValidator"/>, which 
    /// does not inherit <seealso cref="Website.Validation.BaseDynamicValidator"/>. This class does, however, contain the
    /// same methods and properties that the <seealso cref="Website.Validation.BaseDynamicValidator"/> class uses to make
    /// the validator dynamically enabled.
    /// </remarks>
    public class DynamicCompareValidator : CompareValidator {
