...
namespace Website.Validation {
    /// <summary>
    /// A RequiredFieldValidator control that can be enabled/disabled by the same methods and properties as are provided 
    /// in the <seealso cref="Website.Validation.BaseDynamicValidator"/> class
    /// </summary>
    /// <remarks>Note that this class inherits the class <see cref="System.Web.UI.WebControls.RequiredFieldValidator"/>,
    ...
    /// </remarks>
    public class DynamicRequiredFieldValidator : RequiredFieldValidator {
